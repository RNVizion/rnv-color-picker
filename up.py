...
rnv-color-picker: make the test-tooling pins agree with the other four applications.
...
WHAT THIS DOES. Rewrites 7 specifier(s) in 2 file(s) to the fleet
...
EDITS = [('tests/requirements-dev.txt', 'pytest==9.0.2\n', 'pytest>=8.0,<10.0\n', 1), ('tests/requirements-dev.txt', 'pytest-qt==4.5.0\n', 'pytest-qt>=4.4,<5.0\n', 1), ('tests/requirements-dev.txt', 'pytest-cov==7.1.0\n', 'pytest-cov>=5.0,<8.0\n', 1), ('tests/requirements-dev.txt', 'pytest-timeout==2.4.0\n', 'pytest-timeout>=2.4,<3.0\n', 1), ('pyproject.toml', '    "pytest==9.0.2",\n', '    "pytest>=8.0,<10.0",\n', 1), ('pyproject.toml', '    "pytest-qt==4.5.0",\n', '    "pytest-qt>=4.4,<5.0",\n', 1), ('pyproject.toml', '    "pytest-cov==7.1.0",\n', '    "pytest-cov>=5.0,<8.0",\n', 1)]
CANON = {'pytest': '>=8.0,<10.0', 'pytest-qt': '>=4.4,<5.0', 'pytest-cov': '>=5.0,<8.0', 'pytest-timeout': '>=2.4,<3.0', 'pytest-benchmark': '>=4.0,<6.0'}
DECLARING_FILES = ['tests/requirements-dev.txt', 'pyproject.toml']
