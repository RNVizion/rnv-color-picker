...
WHAT CHANGES HERE.
    ...
    Three palette values. Nothing else in this repository changes.

    utils/config.py    scrollbar_handle_hover, all three modes

IT WAS ALREADY THE MODEL for the greys -- `#666666` dark, `#888888` light --
and those two steps keep every other role they hold. This is the one
application where the round is three lines and no retirement.
